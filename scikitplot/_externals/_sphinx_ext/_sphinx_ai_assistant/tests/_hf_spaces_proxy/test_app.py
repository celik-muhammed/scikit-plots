...
Feature-sized cases live under '_cases.app' and are not collected directly.
"""
...
_export_case_tests(globals(), package=__package__, case_package='_cases.app', cases=('cors_origin', 'discovery_contract', 'feedback_payload_inspection', 'share_public_base', 'streaming_state'))
