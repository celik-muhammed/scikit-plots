...
Feature-sized cases live under '_cases.executor' and are not collected directly.
"""
...
_export_case_tests(globals(), package=__package__, case_package='_cases.executor', cases=('resource_lifecycle', 'route_truth'))
