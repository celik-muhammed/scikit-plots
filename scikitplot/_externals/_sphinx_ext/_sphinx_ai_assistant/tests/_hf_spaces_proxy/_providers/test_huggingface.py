...
Feature-sized cases live under '_cases.huggingface' and are not collected directly.
"""
...
_export_case_tests(globals(), package=__package__, case_package='_cases.huggingface', cases=('asr_execution', 'vlm_execution'))
